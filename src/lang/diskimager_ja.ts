...
<context>
    ...
    <message>
        ...
        <translation>デバイスのMBRまたはGPTを読み取り、パーティション間とその後ろにある未パーティション領域を除きます。ブートローダーが置かれる最初のパーティションより前の領域は、パーティションテーブルの後ろ32 MBまではそのまま読み取り、それを超える部分だけを除きます。バックアップGPTはイメージの新しい末尾に移動します。</translation>
    </message>
    <message>
